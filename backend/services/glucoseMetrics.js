...
// GMI (Glucose Management Indicator) — estimated HbA1c equivalent
...
function calculateTIR(readings) {
  if (!readings || readings.length === 0) return null;
...
// CV (Coefficient of Variation) — <36% stable, ≥36% unstable
...
function calculatePeriodMetrics(readings) {
